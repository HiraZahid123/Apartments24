...
export default function Guidebook({ booking, apartment, guidebook }) {
    ...
    return (
        <div className="min-h-screen bg-slate-50 font-sans selection:bg-indigo-100 selection:text-indigo-900">
            ...
            <div className="flex">
                {/* Sidebar (Desktop) */}
                <aside className="hidden lg:flex flex-col w-80 h-screen sticky top-0 bg-white border-r border-slate-100 p-8">
                    <div className="mb-12">
                ...
                {/* Main Content */}
                <main className="flex-1 max-w-4xl mx-auto px-6 pt-24 lg:pt-16 pb-20">
            ...
            <footer className="max-w-4xl mx-auto px-6 pb-20">
                <div className="bg-slate-900 rounded-[3rem] p-12 text-center text-white relative overflow-hidden shadow-2xl">
                    ...
                    <p className="text-slate-400 font-bold mb-8 max-w-xs mx-auto text-sm italic">Our team is available to assist you with any questions during your stay.</p>
                    <div className="flex flex-wrap justify-center gap-4">
                        ...
                        <a 
                            href="mailto:info@apartments24.ee"
                        ...
                        >
                            <Globe className="w-4 h-4" /> Email Us
                        </a>
                    </div>
                </div>
