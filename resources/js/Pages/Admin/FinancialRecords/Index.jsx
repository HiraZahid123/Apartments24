...
export default function Index({ auth, financials, bookings, expenses, filters, filterOptions }) {
    ...
    const handleFilterChange = (updates) => {
        ...
        router.get(route('admin.financial-records.index'), nextFilters, {
            preserveState: true,
            preserveScroll: true,
        });
    };
    ...
    return (
            ...
            header={
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                    ...
                    <div className="flex flex-wrap items-center gap-2">
                        ...
                        {/* Export PDF Button */}
                        <a
                            href={route('admin.financial-records.export', {
                                year: selectedYear,
                                month: selectedMonth,
                                entity: selectedEntity,
                            })}
        ...
        >
            ...
            <div className="py-6 space-y-8">
                {/* Owner / Property / Group Filter Bar */}
                <div className="bg-white p-5 rounded-[2rem] border border-slate-100 shadow-sm flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <p className="text-xs font-black text-slate-400 uppercase tracking-widest">Filter by Owner / Property</p>
                    ...
                    <div className="w-full sm:w-80">
                        ...
                        >
                            <option value="all">🏢 All Properties & Owners</option>
                                ...
                                <table className="w-full text-left border-collapse">
                                    <thead>
                                        <tr className="text-[10px] font-black text-slate-400 uppercase tracking-widest bg-slate-50/30">
                                            ...
                                            <th className="px-8 py-5 border-b border-slate-100">Owner</th>
                                    ...
                                    <tbody className="divide-y divide-slate-50">
                                        {bookings.map((booking) => (
                                            <tr key={booking.id} className="hover:bg-slate-50/60 transition-colors group">
                                                ...
                                                <td className="px-8 py-6">
                                                    <span className="text-xs font-bold text-slate-600">{booking.owner_name}</span>
                                                </td>
                                                <td className="px-8 py-6">
                                ...
                                <table className="w-full text-left border-collapse">
                                    <thead>
                                        <tr className="text-[10px] font-black text-slate-400 uppercase tracking-widest bg-slate-50/30">
                                            ...
                                            <th className="px-8 py-5 border-b border-slate-100">Logged By</th>
                                    ...
                                    <tbody className="divide-y divide-slate-50">
                                        {expenses.map((expense) => (
                                            <tr key={expense.id} className="hover:bg-slate-50/60 transition-colors group">
                                                ...
                                                <td className="px-8 py-6">
                                                    <span className="text-xs font-bold text-slate-600">{expense.owner_name}</span>
                                                </td>
                                                <td className="px-8 py-6">
