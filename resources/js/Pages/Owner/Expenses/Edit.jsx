...
export default function Edit({ auth, apartments, groups = [], expense }) {
    const { data, setData, post, processing, errors } = useForm({
        _method: 'put',
        group_id: expense.apartment_group_id || '',
        apartment_ids: expense.selected_apartment_ids || (expense.apartment_id ? [expense.apartment_id] : []),
            ...
            <div className="py-6 max-w-4xl">
                ...
                <div className="bg-white rounded-[2.5rem] border border-slate-100 shadow-xl overflow-hidden">
                    <div className="p-8 md:p-12 border-b border-slate-50 flex items-center gap-6">
                        ...
                        <div>
                            <h3 className="text-2xl font-black text-slate-900 leading-tight">Edit Operational Cost</h3>
                            <p className="text-slate-400 font-bold">Update expense details, assigned group, or properties.</p>
                        </div>
                    </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 pt-4 border-t border-slate-100">
                            ...
                            <div className="space-y-2">
                                ...
                                <input
                                    ...
                                    className="w-full px-6 py-4 bg-slate-50 border-none rounded-2xl focus:ring-2 focus:ring-brand-orange transition-all font-black text-slate-900 placeholder:text-slate-300"
                                    required
                                />
                            ...
                            <div className="space-y-2">
                                <label className="flex items-center justify-between text-xs font-black text-slate-900 uppercase tracking-widest ml-1">
                                    ...
                                    {expense.proof_image_url && (
                                        <a href={expense.proof_image_url} target="_blank" rel="noopener noreferrer" className="text-indigo-600 hover:text-indigo-800 flex items-center gap-1 font-bold text-xs">
                                            <ExternalLink className="w-3.5 h-3.5" /> View Current
                                        </a>
                                    )}
                                </label>
                                <div className="relative">
                                ...
                                <p className="text-[10px] text-slate-400 font-bold ml-1">Uploading a new file will replace the current receipt.</p>
