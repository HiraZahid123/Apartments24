...
<head>
    ...
    <title>Check-out Reminder - Apartments24</title>
    <style>
        body {
...
<body>
    <div class="container">
        ...
        <div class="button-container">
            <a href="{{ route('guest.checkin.success', ['token' => $booking->checkin_token]) }}" class="button">
                {{ $templateData['labels']['checkout'] ?? 'Easy Checkout' }}
            </a>
        </div>
        <div class="footer">
